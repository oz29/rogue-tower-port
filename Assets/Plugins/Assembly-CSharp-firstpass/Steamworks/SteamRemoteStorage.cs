...
namespace Steamworks
{
	public static class SteamRemoteStorage
	{
		...
		{
			InteropHelp.TestIfAvailableClient();
			bool flag = NativeMethods.ISteamRemoteStorage_GetUGCDetails(CSteamAPIContext.GetSteamRemoteStorage(), hContent, out pnAppID, out var ppchName2, out pnFileSizeInBytes, out pSteamIDOwner);
